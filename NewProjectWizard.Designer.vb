...
Partial Class NewProjectWizard
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(NewProjectWizard))
        ...
        Cancel.FlatAppearance.BorderColor = Color.Silver
